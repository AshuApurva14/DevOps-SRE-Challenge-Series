...
file_path = '/workspaces/DevOps-SRE-Challenge-Series/DevOps_SRE_Challenge_Season_1/Day_2/bucket.json'

# Load bucket data from JSON File to convert it to python object(dict / list)
...
def load_buckets(file_path: str)-> Dict:
    try:
      with open(file_path, 'r') as f:
        ...
        print("Data or file is missing")


# Days since bucket last accessed
...
# Cost report by region and team
...
# Identify deletion and archival buckets
...
# Calculate potential savings by moving to Galcier
...
def main():
    # Load bucket data
    buckets = load_buckets(file_path)["buckets"]
